...
from utils import classification_report, mols2grid_image
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            for i in range(start_iters, num_iters_local):
                ...
                # rep = classification_report(self.data, self.D, session, sample=False)  
                # print(rep) 
                
                # img = mols2grid_image(mols, molsPerRow = 5) 
                # img.show()
